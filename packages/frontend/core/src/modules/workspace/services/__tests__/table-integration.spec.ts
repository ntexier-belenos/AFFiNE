...
describe('Sprint 2 Integration Tests', () => {
  ...
  describe('insertDatabaseBlockCommand Integration', () => {
    it.skip('should generate tableId and register table in workspace index', async () => {
    ...
    it.skip('should handle missing workspace meta gracefully', () => {
      // const mockNext = vi.fn();
      // const ctx = createMockContext();

      // Remove workspace meta
      mockStore.workspace.meta = {} as any; // Fix type error by assigning empty object
    ...
    it.skip('should handle missing block gracefully', () => {
      // const mockNext = vi.fn();
      // const ctx = createMockContext();
  ...
  describe('Workflow Integration', () => {
    it.skip('should complete full table creation and indexing workflow', () => {
      // const mockNext = vi.fn();
      // const ctx = createMockContext();
